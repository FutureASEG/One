namespace One.Web.Infrastructure
{
    using System;
    ...
    public static class HtmlHelperExtensions
    {
        ...
        public static IHtmlString AssemblyVersion(this HtmlHelper helper)
        {
            ...
            return helper.Raw(displayVersion);
        }
        ...
        /// <returns>The retuned value.</returns>
        ...
        private static void SetDisplayVersion()
        {
            ...
            displayVersion =
                string.Format("{4} {0}.{1}.{2} (build {3})", version.Major, version.Minor, version.Build, version.Revision, Settings.Project).Trim();
        }
    }
}
